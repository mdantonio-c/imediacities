...
NON_AV_TITLE_TYPE = (("01", "Main title"), ("02", "Alternative title"))
...
REVISION_STATUS = (("R", "Running"), ("W", "Waiting"))
...
IDENTIFIER_SCHEMES = (
    (
        "ISIL",
        "International Standard for Library Institutions and Related Organisations",
    ),
...
# from EFG datalist
OBJECT_DATA_TYPE = (("Issued", "Issued"), ("Digitised", "Digitised"), ("n/a", "n/a"))
...
P_DATE_TYPE = (
    ...
    ("Date of death"),
    ("Date of death"),
    ("Year of activity(begin)"),
    ("Year of activity(begin)"),
    ("Year of activity(end)"),
    ("Year of activity(end)"),
)
