...
class TestApp(BaseTests):
    ...
    def test_stage_files(self, client): #client e' una fixture di pytest-flask
        ...
        log.debug("*** Start a pause of 20 sec to give time to the import task to finish...")
        ...
        if filename is not None:
            ...
            res5 = client.delete('/api/stage', headers=headers, data=json.dumps(post_data_delete))
